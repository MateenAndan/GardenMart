                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form"
                                        action="../functions/update_category.php" method="post"
                                        ...
                                        <div hidden class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"
                                                    value="<?php echo $one_category['cat_id']; ?>" type="hidden"
                                                    name="cidd" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"
                                                    value="<?php echo $one_category['cat_name']; ?>"
                                                    placeholder="Enter New Category Name" name="cnamee" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-animation w-100 justify-content-center" type="submit"
                                                name="update_category" value="update_category">Update Category</button>
                                        </div>
                                        <script>
