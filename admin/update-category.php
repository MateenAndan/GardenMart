                    ...
                    <div class="row">
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                ...
                                <form class="theme-form theme-form-2 mega-form" action="../functions/update_category.php" method="post" enctype="multipart/form-data">

                                    <div hidden class="mb-4 row align-items-center">
                                        <label class="form-label-title col-sm-3 mb-0">Category ID</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" value = "<?php echo $one_category['cat_id']; ?>" type="hidden" name="cidd" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" value = "<?php echo $one_category['cat_name']; ?>" placeholder="Enter New Category Name" name="cnamee" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="dropdown icon-dropdown">
                                                ...
                                                id="dropdownMenuButton1" data-bs-toggle="dropdown" name = "cimage">
                                                Select Icon
                                            </button>
                            ...
                            <div class="col-12">
                                <button class="btn btn-animation w-100 justify-content-center" type="submit" name="update_category" value="update_category">Update Category</button>
                            </div>
                        </form>
                    </div>
                </div>
