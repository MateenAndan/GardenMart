    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-animation btn-md fw-bold btn--yes" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#exampleModalToggle2">Yes</button>
            </div>
        </div>
    </div>
</div>
