            ...
            <div class="row g-sm-4 g-3">
                ...
                <div class="col-lg-4">
                    <div class="right-side-summery-box">
                        ...
                        <button class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold" type="submit" name="pay_now" id="pay-now" title="Pay now" onclick=payWithPaystack()>Place Order</button>
                        </form>
                    </div>
                </div>
            </div>
